...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 16-07-2026 a las 15:48:19
...
INSERT INTO `anuncio` (`idAnuncio`, `tipoAnuncio`, `titulo`, `descripcion`, `direccionEspecifica`, `pagoReferencia`, `modalidad`, `estado`, `fechaPublicacion`, `idUsuario`, `idDistrito`, `vistas`) VALUES
(1, 'Servicio', 'Reparación de tuberías y caños', 'Soluciono fugas, atoros y cambio de tuberías. Servicio rápido y garantizado.', 'A domicilio en Ate y alrededores', 50.00, 'Presencial', 'Disponible', '2026-06-26 00:29:44', 1, 150103, 7),
(2, 'Servicio', 'Instalación de duchas y termas', 'Instalación profesional de duchas eléctricas y termas a gas.', 'A domicilio', 80.00, 'Presencial', 'Disponible', '2026-06-26 00:29:44', 1, 150103, 0),
(3, 'Servicio', 'Limpieza profunda de hogar', 'Limpieza completa de casas y departamentos. Incluo materiales.', 'Barranco y zonas cercanas', 40.00, 'Presencial', 'Disponible', '2026-06-26 00:29:44', 2, 150104, 0),
(4, 'Servicio', 'Instalaciones eléctricas', 'Cableado, tomacorrientes, tableros y mantenimiento eléctrico.', 'A domicilio', 70.00, 'Presencial', 'Disponible', '2026-06-26 00:29:44', 3, 150106, 0),
(5, 'Trabajo', 'Se busca jardinero por horas', 'Necesito mantenimiento de jardín una vez por semana.', 'Av. La Molina 200', 35.00, 'Presencial', 'Disponible', '2026-06-26 00:29:44', 2, 150104, 4),
(6, 'Trabajo', 'Pintor para departamento', 'Busco pintor para departamento de 80 m2, dos ambientes.', 'Calle Lima 50', 45.00, 'Presencial', 'Disponible', '2026-06-26 00:29:44', 3, 150106, 0),
(7, 'Servicio', 'Limpieza de oficinas en Arequipa', 'Limpieza profunda y mantenimiento de oficinas. Incluyo materiales.', 'Centro de Arequipa', 45.00, 'Presencial', 'Disponible', '2026-06-26 00:34:53', 4, 40101, 0),
(8, 'Servicio', 'Muebles de melamina a medida', 'Diseño y fabricación de closets, reposteros y escritorios.', 'Cayma, Arequipa', 120.00, 'Presencial', 'Disponible', '2026-06-26 00:34:53', 5, 40103, 0),
(9, 'Servicio', 'Mantenimiento de jardines en Cusco', 'Corte de césped, poda y diseño de jardines.', 'Wanchaq, Cusco', 40.00, 'Presencial', 'Disponible', '2026-06-26 00:34:53', 6, 80108, 0),
(10, 'Servicio', 'Electricista a domicilio Trujillo', 'Instalaciones, cableado y reparación de tableros eléctricos.', 'Centro de Trujillo', 65.00, 'Presencial', 'Disponible', '2026-06-26 00:34:53', 7, 130101, 0),
(11, 'Servicio', 'Pintura de casas en Chiclayo', 'Pintado de interiores y fachadas, acabados de calidad.', 'Chiclayo centro', 55.00, 'Presencial', 'Disponible', '2026-06-26 00:34:53', 8, 140101, 1),
(13, 'Trabajo', 'Busco carpintero en Arequipa', 'Necesito carpintero para armado de muebles por proyecto.', 'Av. Ejército 900', 90.00, 'Presencial', 'Disponible', '2026-06-26 00:34:53', 4, 40101, 0),
(14, 'Trabajo', 'Se necesita jardinero en Cusco', 'Mantenimiento semanal de jardín en vivienda.', 'Av. La Cultura 1200', 35.00, 'Presencial', 'Disponible', '2026-06-26 00:34:53', 6, 80108, 0),
(15, 'Trabajo', 'Electricista para local Trujillo', 'Instalación eléctrica de local comercial nuevo.', 'Av. España 300', 70.00, 'Presencial', 'Disponible', '2026-06-26 00:34:53', 7, 130101, 0),
(17, 'Trabajo', 'Pintor de interiores', 'Necesito un pintor para sala', NULL, NULL, 'Presencial', 'Disponible', '2026-06-27 15:35:48', 2, NULL, 0),
(18, 'Servicio', 'Electricista a domicilio', 'Instalaci¾n de luces', NULL, NULL, 'Presencial', 'Disponible', '2026-06-27 15:35:48', 3, NULL, 7),
(19, 'Trabajo', 'Limpieza general', 'Limpiar casa 2 pisos', NULL, NULL, 'Presencial', 'Disponible', '2026-06-27 15:35:48', 4, NULL, 1),
(20, 'Trabajo', 'laburar de mono', 'trabajras', 'ensenada 123', 500.00, 'Presencial', 'En proceso', '2026-06-28 18:00:05', 10, 140119, 7);
...
--
-- Volcado de datos para la tabla `anunciosfavoritos`
--

INSERT INTO `anunciosfavoritos` (`idFavorito`, `fechaGuardado`, `idUsuario`, `idAnuncio`) VALUES
(3, '2026-06-29 12:00:26', 10, 19);
...
INSERT INTO `calificacion` (`idCalificacion`, `puntaje`, `comentario`, `fecha`, `idUsuarioCalificado`, `idUsuarioCalificador`) VALUES
(1, 5, 'Excelente trabajo, muy puntual y ordenado.', '2026-06-26 00:29:44', 1, 2),
(2, 4, 'Buen servicio, solucionó la fuga rápido.', '2026-06-26 00:29:44', 1, 3),
(3, 5, 'Dejó la casa impecable, la recomiendo.', '2026-06-26 00:29:44', 2, 1),
(4, 5, 'Muy profesional con la instalación eléctrica.', '2026-06-26 00:29:44', 3, 1),
(5, 5, 'Dejó la oficina impecable, muy recomendable.', '2026-06-26 00:34:53', 4, 5),
(6, 4, 'Buen acabado en los muebles, cumplió el plazo.', '2026-06-26 00:34:53', 5, 4),
(7, 5, 'El jardín quedó precioso, gracias Rosa.', '2026-06-26 00:34:53', 6, 7),
(8, 5, 'Trabajo eléctrico rápido y seguro.', '2026-06-26 00:34:53', 7, 8);
...
(1, 'Gasfitería', 'gasfiteria.png'),
(2, 'Electricidad', 'electricidad.png'),
(3, 'Limpieza', 'limpieza.png'),
(4, 'Jardinería', 'jardineria.png'),
(5, 'Carpintería', 'carpinteria.png'),
(6, 'Pintura', 'pintura.png'),
(7, 'Servicios Varios', 'servicios_varios.png');
...
--
-- Volcado de datos para la tabla `categoriasanuncio`
--
...
(1, 'Puntualidad', 'General'),
(2, 'Responsabilidad', 'General'),
(3, 'Honestidad', 'General'),
(4, 'Trabajo en equipo', 'General'),
(5, 'Atencion al detalle', 'General'),
(6, 'Rapidez', 'General'),
(7, 'Experiencia comprobable', 'General'),
(8, 'Herramientas propias', 'General'),
(9, 'Disponibilidad inmediata', 'General'),
(10, 'Buen trato al cliente', 'General'),
(11, 'Limpieza en el trabajo', 'General'),
(12, 'Garantia del trabajo', 'General');
...
INSERT INTO `notificacion` (`idNotificacion`, `idUsuario`, `mensaje`, `link`, `leida`, `fecha`) VALUES
(5, 10, 'Tienes una nueva postulación en uno de tus anuncios.', 'views/user/postulaciones_recibidas.php', 1, '2026-06-29 21:44:03'),
(6, 11, 'Tu postulación fue aceptada.', 'views/user/mis_postulaciones.php', 1, '2026-06-29 21:44:15');
...
INSERT INTO `postulacion` (`idPostulacion`, `estado`, `fecha`, `idAnuncio`, `idUsuario`) VALUES
(1, 'Pendiente', '2026-06-27 15:35:48', 17, 1),
(2, 'Aceptado', '2026-05-27 15:35:48', 18, 1),
(3, 'Rechazado', '2026-02-27 15:35:48', 19, 1),
(6, 'Pendiente', '2026-06-28 18:01:32', 18, 10),
(7, 'Aceptado', '2026-06-28 19:09:07', 20, 11);
...
INSERT INTO `usuario` (`idUsuario`, `fotoPerfil`, `nombres`, `apellidos`, `descripcionPerfil`, `telefono`, `correo`, `password`, `direccionDomicilio`, `codigoPostal`, `fechaRegistro`, `estado`, `rol`, `idDistrito`, `notif_ofertas`, `notif_vistas`, `notif_boletin`, `visibilidad`, `remember_token`, `remember_token_expira`) VALUES
(1, 'default.png', 'Carlos', 'Ramírez', 'Gasfitero con 10 años de experiencia en instalaciones y reparaciones.', '987654321', 'carlos@chamba.com', '$2y$10$qiLfCbfHk9uiXpDQ5AjQV.NyUNvtACo2UstmaXvNxp66bwymykFAG', 'Av. Siempre Viva 123', '15001', '2026-06-26 00:29:44', 'Activo', 'admin', 150103, 1, 1, 0, 'publico', NULL, NULL),
(2, 'default.png', 'María', 'Flores', 'Especialista en limpieza de hogares y oficinas.', '912345678', 'maria@chamba.com', '$2y$10$WGJC8H1poCdOWJhl7hAWF.AJsaHcHgzXW2w/N8eLIwlFDhe/tU5ty', 'Jr. Las Flores 456', '15004', '2026-06-26 00:29:44', 'Activo', 'usuario', 150104, 1, 1, 0, 'publico', NULL, NULL),
(3, 'default.png', 'Jorge', 'Mendoza', 'Electricista certificado, atención rápida a domicilio.', '999888777', 'jorge@chamba.com', '$2y$10$WGJC8H1poCdOWJhl7hAWF.AJsaHcHgzXW2w/N8eLIwlFDhe/tU5ty', 'Calle Los Pinos 789', '15006', '2026-06-26 00:29:44', 'Activo', 'usuario', 150106, 1, 1, 0, 'publico', NULL, NULL),
(4, 'default.png', 'Lucía', 'Quispe', 'Servicio de limpieza para hogares y oficinas en Arequipa.', '954111222', 'lucia@chamba.com', '$2y$10$WGJC8H1poCdOWJhl7hAWF.AJsaHcHgzXW2w/N8eLIwlFDhe/tU5ty', 'Calle Mercaderes 100', '04001', '2026-06-26 00:34:53', 'Activo', 'usuario', 40101, 1, 1, 0, 'publico', NULL, NULL),
(5, 'default.png', 'Pedro', 'Huamán', 'Carpintero, fabricación y reparación de muebles a medida.', '954333444', 'pedro@chamba.com', '$2y$10$WGJC8H1poCdOWJhl7hAWF.AJsaHcHgzXW2w/N8eLIwlFDhe/tU5ty', 'Av. Cayma 250', '04017', '2026-06-26 00:34:53', 'Activo', 'usuario', 40103, 1, 1, 0, 'publico', NULL, NULL),
(6, 'default.png', 'Rosa', 'Mamani', 'Jardinería y mantenimiento de áreas verdes en Cusco.', '954555666', 'rosa@chamba.com', '$2y$10$WGJC8H1poCdOWJhl7hAWF.AJsaHcHgzXW2w/N8eLIwlFDhe/tU5ty', 'Calle Sol 333', '08002', '2026-06-26 00:34:53', 'Activo', 'usuario', 80108, 1, 1, 0, 'publico', NULL, NULL),
(7, 'default.png', 'Diego', 'Castro', 'Electricista a domicilio en Trujillo, trabajos garantizados.', '954777888', 'diego@chamba.com', '$2y$10$WGJC8H1poCdOWJhl7hAWF.AJsaHcHgzXW2w/N8eLIwlFDhe/tU5ty', 'Jr. Pizarro 480', '13001', '2026-06-26 00:34:53', 'Activo', 'usuario', 130101, 1, 1, 0, 'publico', NULL, NULL),
(8, 'default.png', 'Ana', 'Vásquez', 'Pintura de interiores y exteriores en Chiclayo.', '954999000', 'ana@chamba.com', '$2y$10$WGJC8H1poCdOWJhl7hAWF.AJsaHcHgzXW2w/N8eLIwlFDhe/tU5ty', 'Av. Balta 700', '14001', '2026-06-26 00:34:53', 'Activo', 'usuario', 140101, 1, 1, 0, 'publico', NULL, NULL),
(10, '6a41a7347104d.png', 'juns', 'diaz', 'ju', '999478470', 'ju@gmail.com', '$2y$10$iWH1WCsoHz2TLNigv5PeWuEDUtUo1/5gR03BvoQnrNO9GHMk3mmz.', 'ensenada', '14000', '2026-06-29 00:59:00', 'Activo', 'admin', 180302, 1, 1, 0, 'publico', NULL, NULL),
(11, '6a41b79e1ce80.png', 'jose', 'pepe', '123', '888888', 'pepe@gmail.com', '$2y$10$VdcNpscfaOe8ljFgMEKCv.w8ApCvYFC5CZ826WjAd/DIBZLr/MAYu', 'ensenada', '14000', '2026-06-29 02:09:02', 'Activo', 'admin', 170101, 1, 1, 0, 'publico', NULL, NULL),
(19, '6a483bdf4a401.png', 'junniorss', 'diaz', 'soy el mejor en todo', '999478740', 'jus@gmail.com', '$2y$10$EmJJT6tmI02MzS4cu3xk9e4p3UIlslN2AyksCD60rBQ8zrlIqyZIe', 'ensenada pimentel xd', '30062', '2026-07-04 00:46:55', 'Activo', 'usuario', 180105, 1, 1, 0, 'publico', NULL, NULL);
...
--
-- Volcado de datos para la tabla `usuariohabilidad`
--
...
--
ALTER TABLE `anuncio`
  MODIFY `idAnuncio` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;

--
-- AUTO_INCREMENT de la tabla `anunciosfavoritos`
--
ALTER TABLE `anunciosfavoritos`
  MODIFY `idFavorito` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT de la tabla `calificacion`
--
ALTER TABLE `calificacion`
  MODIFY `idCalificacion` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
...
--
ALTER TABLE `categoriasanuncio`
  MODIFY `idCategoriasAnuncio` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;

--
-- AUTO_INCREMENT de la tabla `habilidad`
--
ALTER TABLE `habilidad`
  MODIFY `idHabilidad` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT de la tabla `notificacion`
--
ALTER TABLE `notificacion`
  MODIFY `idNotificacion` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT de la tabla `postulacion`
--
ALTER TABLE `postulacion`
  MODIFY `idPostulacion` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT de la tabla `reporte`
--
ALTER TABLE `reporte`
  MODIFY `idReporte` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT de la tabla `trabajadoresfavoritos`
--
ALTER TABLE `trabajadoresfavoritos`
  MODIFY `idTrabajadorFavorito` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `usuariohabilidad`
  MODIFY `idHabilidadUser` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
