            ...
            <div class="categories_carousel">
                ...
                <div class="carousel_wrapper" id="carouselWrapper">
                    <a href="" class="categories_card">
                        <img src="<?= BASE_URL ?>assets/img/hogar_mantenimiento.png" alt="hogar y mantenimiento">
                        <h3>Hogar y Mantenimiento</h3>
                    </a>
                    <a href="" class="categories_card">
                        <img src="<?= BASE_URL ?>assets/img/jardineria.png" alt="jardinería">
                        <h3>Jardinería</h3>
                    </a>
                    <a href="" class="categories_card">
                        <img src="<?= BASE_URL ?>assets/img/construccion.png" alt="construcción">
                        <h3>Construcción</h3>
                    </a>
                    <a href="" class="categories_card">
                        <img src="<?= BASE_URL ?>assets/img/limpieza.png" alt="limpieza">
                        <h3>Limpieza</h3>
                    </a>
                    <a href="" class="categories_card">
                        <img src="<?= BASE_URL ?>assets/img/mascotas.png" alt="mascotas">
                        <h3>Mascotas</h3>
                    </a>
                    <a href="" class="categories_card">
                        <img src="<?= BASE_URL ?>assets/img/cocina_eventos.png" alt="cocina y eventos">
                        <h3>Cocina y Eventos</h3>
                    </a>
                    <a href="" class="categories_card">
                        <img src="<?= BASE_URL ?>assets/img/mudanzas_carga.png" alt="mudanzas y carga">
                        <h3>Mudanzas y Carga</h3>
                    </a>
                    <a href="" class="categories_card">
                        <img src="<?= BASE_URL ?>assets/img/servicios_digitales.png" alt="servicios digitales">
                        <h3>Servicios Digitales</h3>
                    </a>
                    <a href="" class="categories_card">
                        <img src="<?= BASE_URL ?>assets/img/servicios_varios.png" alt="servicios varios">
                        <h3>Servicios Varios</h3>
                    </a>
                    <a href="" class="categories_card">
                        <img src="<?= BASE_URL ?>assets/img/transporte_delivery.png" alt="transporte y delivery">
